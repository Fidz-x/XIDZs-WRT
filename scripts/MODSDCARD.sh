...
main() {
    ...
    local builds=()
    if [[ "$MATRIXTARGET" == "MOD-SDCARD Amlogic s905x HG680P" ]]; then
        builds=(
            ...
            "_s905x_k6.12.32:meson-gxl-s905x-p212.dtb:HG680P"
        )
    elif [[ "$MATRIXTARGET" == "MOD-SDCARD Amlogic s905x B860H" ]]; then
        builds=(
            ...
            "_s905x-b860h_k6.12.32:meson-gxl-s905x-b860h.dtb:B860H"
        )
    fi
