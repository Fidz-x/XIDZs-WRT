...
PACKAGES+=" htop lolcat python3-pip zram-swap luci-app-poweroffdevice luci-app-ramfree \
luci-app-ttyd luci-app-lite-watchdog luci-app-ipinfo luci-app-droidnet luci-app-mactodong"
